    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="container max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold">Install VibeSphere</h1>
        </div>
      </header>
      ...
      <main className="container max-w-2xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h2 className="text-3xl font-bold">Get VibeSphere on Your Device</h2>
          <p className="text-muted-foreground max-w-md mx-auto">
            Install VibeSphere for a faster, app-like experience with offline support and quick access from your home screen.
          </p>
        </div>
          ...
          <Card className="border-green-500/50 bg-green-500/10">
            <CardContent className="p-6 text-center">
              <p className="text-green-500 font-semibold text-lg">
                ✓ VibeSphere is installed on your device!
              </p>
            </CardContent>
          </Card>
        )}
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">VibeSphere must be opened in Safari browser</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="font-medium">VibeSphere will open in its own window</p>
                  </div>
                </div>
              </CardContent>
            </Card>
