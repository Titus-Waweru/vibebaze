...
const AiAssistant = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hey there! 👋 I'm VibeBot, your VibeBaze assistant. Ask me anything about posting, earning, or using the app! 😊" }
  ]);
  ...
  const send = async () => {
    ...
    try {
      ...
      if (!session) {
        toast.error("Please log in to use VibeBot");
        setIsLoading(false);
        return;
      }
